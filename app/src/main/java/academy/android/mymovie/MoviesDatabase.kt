    ...
    private val moviesList: ArrayList<Movie> = arrayListOf(
        Movie(
            ...
            arrayListOf(
                ...
                Actor(
                    "Chris Evans",
                    "https://pcdn.columbian.com/wp-content/uploads/2020/08/People_Chris_Evans_23890.jpg-faf5b-1226x0-c-default.jpg"
                ),
                Actor(
                    "Mark Ruffalo",
                    "https://img1.looper.com/img/gallery/mark-ruffalo-b/intro-1550586708.jpg"
                ),
                Actor(
                    "Chris Hemwworth",
